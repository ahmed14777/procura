  ...
  return (
    <main className="min-h-screen bg-slate-900 px-5 py-8 text-white">
      <div className="mx-auto max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">Cliente: {clientName || "Caricamento..."}</p>
        ...
        <button type="button" onClick={clearSignature} className="mt-2 w-full rounded-lg border border-slate-600 py-2 text-sm text-slate-300">
          Cancella firma
        </button>
